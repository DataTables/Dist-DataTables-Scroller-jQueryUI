# Scroller for DataTables with styling for [jQuery UI](http://jqueryui.com/)

This package contains distribution files required to style [Scroller extension](https://datatables.net/extensions/scroller) for [DataTables](https://datatables.net/) with styling for [jQuery UI](http://jqueryui.com/).
...
```
var $ = require( 'jquery' );
require( 'datatables.net-scroller-jqui' )( $ );
```
